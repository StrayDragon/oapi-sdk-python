from lark_oapi.remaintain.extra.service.calendar.v4.api import Service as CalendarV4Service
from sample.config.config import (
    test_config_with_memory_store,
    test_config_with_redis_store,
)
from lark_oapi.remaintain.extra import DOMAIN_FEISHU, DOMAIN_LARK_SUITE, Config
...
def test_calendar_acls_delete():
    ...
    resp = (
        service.calendar_acls.delete()
        .set_calendar_id("calendar_id")
        .set_acl_id("aclId")
        .do()
    )
