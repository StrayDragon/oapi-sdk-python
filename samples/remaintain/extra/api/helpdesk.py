from lark_oapi.remaintain.extra.api import (
    Request,
    FormData,
    FormDataFile,
    set_timeout,
...
def test_ticket_detail():
    req = Request(
        "/open-apis/helpdesk/v1/tickets/6971250929135779860",
        "GET",
        ACCESS_TOKEN_TYPE_TENANT,
        None,
