...
from lark_oapi.remaintain.extra.service.docx.v1 import Service as DocxService, model
...
def test_create_doc():
    ...
    req_call = service.documents.create(
        body, None, "u-12kPy7i1Zf3Xg6YBJaoncNgk2cmBk1AFiww0lkC8G9SO"
    )
    resp = req_call.do()
...
def test_get_raw_doc():
    req_call = service.documents.raw_content(
        None, "u-12kPy7i1Zf3Xg6YBJaoncNgk2cmBk1AFiww0lkC8G9SO"
    )
    req_call.set_document_id("doxcnEldNqtJ9Og88tf6dnVVNNf")
    resp = req_call.do()
    print("request id = %s" % resp.get_request_id())
...
def test_list_blocks():
    req_call = service.document_blocks.list(
        None, "u-12kPy7i1Zf3Xg6YBJaoncNgk2cmBk1AFiww0lkC8G9SO"
    )
    req_call.set_document_id("doxcnEldNqtJ9Og88tf6dnVVNNf")
...
def test_create_blocks():
    ...
    req_call = service.document_block_childrens.create(
        body, None, "u-12kPy7i1Zf3Xg6YBJaoncNgk2cmBk1AFiww0lkC8G9SO"
    )
    req_call.set_document_id("doxcnEldNqtJ9Og88tf6dnVVNNf")
...
def test_update_blocks():
    ...
    req_call = service.document_blocks.patch(
        req, None, "u-03ETXnQCx2bGzlCpiLkBxA0k0Yr5k1C9XwG001a00csd"
    )
    req_call.set_document_id("doxcnEldNqtJ9Og88tf6dnVVNNf")
    req_call.set_block_id("doxcnKIaoQecc6GWwozvApH6rOf")
...
def test_list_sub_blocks():
    req_call = service.document_block_childrens.get(
        None, "u-12kPy7i1Zf3Xg6YBJaoncNgk2cmBk1AFiww0lkC8G9SO", None
    )
    req_call.set_document_id("doxcnEldNqtJ9Og88tf6dnVVNNf")
    req_call.set_block_id("doxcnKIaoQecc6GWwozvApH6rOf")
    req_call.set_page_size(100)
